...
class testAGPulldownDLHandler(TestHandlerBase):
    ...
    def test_post_multiple_surverys(self):
        self.mock_login_admin()
        response = self.post('/ag_pulldown/download/',
                             {'barcodes': ('000001000,000001001,000001002,'
                                           '000037583,000066526,000031568,'
                                           '000037555,000065893,000067690,'
                                           '000049932,000063380,000063381,'
                                           '000006616,000030821,000030822,'
                                           '000030823,000069020,000069021,'
                                           '000069022,'),
                              'blanks': '',
                              'external': '',
                              'selected_ag_surveys': '-1,-2,-3,-4,-5',
    ...
    def test_post_select_surveys(self):
        ...
        # no blanks
        response = self.post('/ag_pulldown/download/',
                             {'barcodes': ('000001445,000001446,000001447,'
                                           '000001448,100001449,000016180,'
                                           '000015296,000015297,000015298,'
                                           '000015299,000015300,000016280,'
                                           '000016281,000016282,000016283,'
                                           '000016284'),
                              'blanks': '',
